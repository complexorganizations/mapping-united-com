...
class _GoogleMapWidgetState extends State<GoogleMapWidget> {
        ...
        if(parkingState is ParkingLoaded) {
          ...
          return GoogleMap(
            initialCameraPosition: CameraPosition(
              target: LatLng(40.7488003, -73.853232),
              zoom: 14.4746,
            ),
  ...
  Set<Marker> createCustomMarkers({required List<ParkingEntity> parkingDetails}) {
    ...
    for(int i = 0; i < parkingDetails.length; i++) {
      markers.add(
        Marker(
          ...
          position: LatLng(parkingDetails[i].Address!.latitude, parkingDetails[i].Address!.longitude),
  ...
  void _showBottomModalSheet(BuildContext context, ParkingEntity parkingDetails) {
